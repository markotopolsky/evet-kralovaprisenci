...
const variantStyles = {
  ...
  accent: "bg-accent text-text hover:bg-accent-dark focus:ring-accent",
  outline:
    "border-2 border-border-light text-text hover:border-primary hover:text-primary focus:ring-primary",
